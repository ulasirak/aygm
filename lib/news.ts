...
export const allNews: NewsItem[] = [
  {
    ...
    category: "Tören",
    date: "7 Temmuz 2025",
    title: "2. Etap'ın Temeli Atıldı: Sayın Bakanımız Abdulkadir Uraloğlu Konya'da",
    summary:
  ...
  },
  {
    ...
    category: "Vizyon",
    date: "2025",
    title: "Sayın Bakanımız Abdulkadir Uraloğlu: 'Konya'nın Raylı Ağı 134 km'ye Çıkacak'",
    summary:
